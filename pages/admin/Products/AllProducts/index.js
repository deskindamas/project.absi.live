    ...
    <div>
      <div className="md:px-6">
        ...
        <div className="m-5 p-5">
            ...
            <div className="w-[50%] flex justify-end " onClick={() => {router.push('/admin/Products/addNewProduct')}}>
              <button  className="bg-skin-primary text-white py-1 px-3 rounded-md">Add Product</button>
            </div>
            </div>
          </div>
