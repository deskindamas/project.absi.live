...
function Category({storeType , refetch}) {
        ...
        <DialogContent>
          <Stack spacing={1} margin={3}>
            <div className="flex flex-col justify-start items-start w-full ">
              <p className="text-lg ">
                {`Are you sure you want to remove this category from the ${storeType} store type ?`}
              </p>
              <p className="text-xl pt-4">category name</p>
            </div>
          </Stack>
        </DialogContent>
        <DialogActions>
