...
function ProductCustomer({ product }) {
  ...
  return (
    ...
    className="bg-white overflow-hidden shadow-2xl rounded-lg
     md:w-[100%] w-[80%] h-[100%] items-center justify-center mx-auto"
      >
    ...
    <div className="flex flex-col justify-start items-start gap-3 py-4 px-4">
      <h3 className="md:h-[100px] h-auto text-gray-600 md:text-2xl text-lg font-medium overflow-ellipsis md:line-clamp-2 line-clamp-3 select-none cursor-auto " 
      title={product.name}
      >
        {product.name}
      </h3>
    ...
    <p className=" text-gray-700 text-base font-light overflow-ellipsis line-clamp-2 select-none cursor-auto"
