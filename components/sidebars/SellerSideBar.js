...
// import Logo from '../images/tawasylogowhite.png';
// import Logo from '../../pages/images/'
import Logo from '../../public/images/tawasylogowhite.png';
// import ProfileLogo from '../images/profile-removebg-preview.png'
  ...
  return (
    <div  className='w-full h-full ' >
      ...
      > 
        <div className="space-y-3">
         ...
         <BsColumns className="block text-[20px] text-white " />
                    <p className="hidden md:block" style={{marginLeft:"43px"}} >Dashboard</p>
     ...
     <Link className="flex items-center p-2 space-x-3 rounded-md text-gray-100"  href="/">
        ...
        <li className={`pt-3`}>
     <Link className="flex items-center p-2 space-x-3 rounded-md text-gray-100"  href="/seller/products">
        <BsBox className="block text-[20px] text-white "/>
        <p className="hidden md:block"  >All Products</p>
              ...
              <Link
               ...
               <FiSettings className="block text-[20px] text-white "  />
                    <p className="hidden md:block" style={{marginLeft:"43px"}} >Settings</p>
              ...
              <Link
               ...
               <CiLogout className="block text-[20px] text-white"  />
                    <p className="hidden md:block" style={{marginLeft:"43px"}} >Logout</p>
